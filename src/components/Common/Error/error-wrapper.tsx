  ...
  return (
    <div className="bg-white text-black px-5">
      ...
      <div className="flex justify-center items-center">
        <Lottie loop animationData={jsonObj} play style={{ width: 350, height: 350 }} />
      </div>
      <Spacing size={70} />
      <div className="flex justify-center items-center">
        <Link href="/" className="bg-main w-full rounded-lg text-white font-medium mx-4 py-3 text-center">
          홈으로 돌아가기
        </Link>
      </div>
    </div>
